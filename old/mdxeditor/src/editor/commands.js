/**
 * @file mdxeditor/editor/commands.js
 */

/** @typedef {import("@codemirror/view").EditorView} EditorView */

/**
 * Intelligently wraps the selection with Markdown formatting characters.
 * @param {EditorView} view
 * @param {string} formattingChars - e.g., "**" or "*"
 */
 ...
 * @param {import("@codemirror/view").EditorView} view
 * @param {function(string): void} callback - 由宿主应用提供的 AI 处理函数。
 */
 ...
 * 将整个文档的内容传递给回调函数。
 * @param {import("@codemirror/view").EditorView} view
 * @param {function(string): void} callback - 由宿主应用提供的保存处理函数。
 */
...
/**
 * [NEW] 触发浏览器打印功能。
 * @param {import('./index.js').MDxEditor} editor // [FIX] Changed 'view' to 'editor' and corrected type
 */
