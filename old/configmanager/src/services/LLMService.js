 ...
 */
import { EVENTS } from '../constants.js'; // [MODIFIED] 移除了 PROTECTED_AGENT_IDS
...
export class LLMService {
     ...
     * @param {string[]} [protectedAgentIds=[]] - [新增] 注入受保护的 Agent ID 列表
     */
    constructor(llmRepository, tagRepository, eventManager, protectedAgentIds = []) {
        this.repo = llmRepository;
        this.tagRepo = tagRepository;
        this.events = eventManager;
        this.protectedAgentIds = protectedAgentIds; // [新增] 保存配置
    }
    ...
    async removeAgent(agentId) {
        ...
        if (this.protectedAgentIds.includes(agentId)) {
