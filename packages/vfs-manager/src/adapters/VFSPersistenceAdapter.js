/**
 * @file vfsManager/adapters/VFSPersistenceAdapter.js
 * @fileoverview VFSPersistenceAdapter - 让 VFSManager 实现 IPersistenceAdapter 接口
 */
...
export class VFSPersistenceAdapter extends IPersistenceAdapter {
    /**
     * @param {import('../VFSManager').VFSManager} vfsManager
     * @param {string} nodeId - 当前文档的节点ID
     */
    constructor(vfsManager, nodeId) {
        super();
        this.vfs = vfsManager;
        this.nodeId = nodeId;
