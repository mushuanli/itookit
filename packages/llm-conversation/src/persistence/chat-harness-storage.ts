...
export class ChatHarnessStorageResolver implements SessionStorageResolver {
    ...
    async resolve(reference: StorageBindingRef): Promise<ResolvedStorageBinding> {
        ...
        return {
            ...
            rootPath: `${root}/.harness`,
        };
    }
}

export function chatHarnessStorage(sessionId: string): StorageBindingRef {
