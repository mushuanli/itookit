/**
 * @file #mdxeditor/mdxplugins/cloze-controls.plugin.js
 * @desc [NEW] Provides floating buttons in the bottom-right corner to control cloze elements in render mode.
 */
