/**
 * @file vfs-ui/ui/components/NodeList/popovers/SettingsPopover.ts
 * @desc Settings popover. Uses ICommandPort instead of Coordinator.
 */
import type { ICommandPort } from '../../../../contracts/ports';
import type { UISettings } from '../../../../contracts/types';
...
export class SettingsPopover {
  ...
  private handleChange = (event: Event): void => {
    ...
    this.commandBus.execute('ui:updateSettings', { settings: newSettings });
