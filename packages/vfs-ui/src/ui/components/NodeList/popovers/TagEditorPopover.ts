/**
 * @file vfs-ui/ui/components/NodeList/popovers/TagEditorPopover.ts
 * @desc Tag editor popover lifecycle management.
 */
import type { TagEditorFactory } from '../../../../contracts/types';

export interface TagEditorPopoverOptions {
  initialTags: string[];
...
export class TagEditorPopover {
  ...
  show(options: TagEditorPopoverOptions): void {
    this.hide();
