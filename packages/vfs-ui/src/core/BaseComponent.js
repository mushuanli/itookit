/**
 * @file vfs-ui/core/BaseComponent.js
 * @desc A base class for UI components to handle common lifecycle and state management tasks.
 */

/** @typedef {import('../stores/VFSStore.js').VFSStore} VFSStore */
/** @typedef {import('../core/Coordinator.js').Coordinator} Coordinator */

export class BaseComponent {
    /**
     * @param {object} params
     * @param {HTMLElement} params.container - The DOM element to mount the component into.
     * @param {VFSStore} params.store - The application's state store.
     * @param {Coordinator} params.coordinator - The application's event coordinator.
     */
     ...
     * @param {import('../types/types.js')._VFSUIState} globalState
     * @private
     */
     ...
     * @param {import('../types/types.js')._VFSUIState} globalState - The global application state.
