...
```javascript
import { LLMDriver } from 'llm-fusion-kit';
...
```javascript
import { LLMDriver, LLMChain } from 'llm-fusion-kit';

const client = new LLMDriver({ provider: 'openai', apiKey: '...' });
